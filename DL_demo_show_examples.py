...
import random
random_num = random.sample(range(1, 100), 10) ##### last number (10) is the number of examples which will be evaluated.
...
for n in random_num: #eventually, random_num will need to be range(files_key)
    print('Example:')
    print(n)
...
######## NEED TO GET MEASUREMENTS data into the following format:
#extreme_points_ori
#[[ 55 178]
# [161  80]
# [156 142]
